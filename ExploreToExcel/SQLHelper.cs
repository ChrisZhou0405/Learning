...
namespace ExploreToExcel
{
    public abstract class SQLHelper
    {
        ...
        public static readonly string ConnectionStringLocalTransaction = "data source=10.2.133.41;initial catalog=Gz_ShoppingMall20180521;persist security info=True;user id=phl;password=asdfasdf;MultipleActiveResultSets=true";
        ...
        public static DataTable GetDataSet(string conStr,string sql)
        {
            DataTable table = new DataTable();
            try
            {
                DataSet ds = ExecuteDataSet(conStr, CommandType.Text, sql);
                if (ds != null)
                {
                    table = ds.Tables[0];
                }
